    ...
    <div className='footerMainDiv'>
      <div className='footerInfo'>
        ...
        <div className='footerLink'>
          {/* <a href='https://github.com/nedned1108/capstone-project-shootstarter' target="_blank">{<i class="fa-brands fa-github"></i>}</a>
          <a href='https://www.linkedin.com/in/ned-nguyen-693575257/' target="_blank">{<i class="fa-brands fa-linkedin"></i>}</a> */}
